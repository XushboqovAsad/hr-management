...
public class ExplanationService {
    ...
    List<DepartmentDisciplineReportResponse> reportByDepartment(LocalDate from, LocalDate to) {
        ...
        Map<UUID, uz.hrms.other.ExplanationService.DepartmentReportAccumulator> accumulators = new LinkedHashMap<>();
        ...
        for (ExplanationIncident incident : incidents) {
            ...
            uz.hrms.other.ExplanationService.DepartmentReportAccumulator accumulator = accumulators.computeIfAbsent(departmentId, key -> new uz.hrms.other.ExplanationService.DepartmentReportAccumulator());
        ...
        for (Map.Entry<UUID, uz.hrms.other.ExplanationService.DepartmentReportAccumulator> entry : accumulators.entrySet()) {
            uz.hrms.other.ExplanationService.DepartmentReportAccumulator value = entry.getValue();
