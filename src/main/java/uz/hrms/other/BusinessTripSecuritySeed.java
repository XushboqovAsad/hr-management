...
@Configuration
class BusinessTripSecuritySeed {

    @Bean
    ApplicationRunner businessTripPermissionsSeeder(
        PermissionRepository permissionRepository,
        RoleRepository roleRepository,
        RolePermissionRepository rolePermissionRepository
    ) {
        return args -> {
            Permission read = upsertPermission(permissionRepository, "BUSINESS_TRIP", "READ", "Read business trips");
            Permission write = upsertPermission(permissionRepository, "BUSINESS_TRIP", "WRITE", "Create and update business trips");
            Permission approve = upsertPermission(permissionRepository, "BUSINESS_TRIP", "APPROVE", "Approve business trips");
